...
public class SafeWebChromeClient extends WebChromeClient {
    private final String TAG = "SafeWebChromeClient";
    private JsCallJava mJsCallJava;
    private boolean mIsInjectedJS;

    /* package */ void addJavascriptInterface(Object interfaceObj, String interfaceName) {
        mJsCallJava = new JsCallJava(interfaceObj, interfaceName);
    }
